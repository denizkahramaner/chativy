class LoadData < ActiveRecord::Migration
    def up
        ...
        photo10 = Photo.new(:date_time => "2010-05-20 23:48:00",
                           :file_name => "obama_jedi_knight.jpg")
        photo10.user = bh
        photo10.save(:validate =>false)
        photo11 = Photo.new(:date_time => "2010-05-20 23:48:00",
                           :file_name => "obama4.jpg")
        photo11.user = bh
        photo11.save(:validate =>false)
        photo12 = Photo.new(:date_time => "2010-05-20 23:48:00",
                           :file_name => "obama5.jpg")
        photo12.user = bh
        photo12.save(:validate =>false)
        photo13 = Photo.new(:date_time => "2010-05-20 23:48:00",
                           :file_name => "obama6.jpg")
        photo13.user = bh
        photo13.save(:validate =>false)
